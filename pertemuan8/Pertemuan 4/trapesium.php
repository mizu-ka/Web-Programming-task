    ...
    <form action="trapesiumaction.php" method="post">
        <table>
            ...
            <tr>
                <td>Masukkan b</td>
                <td>:</td>
                <td><input type="number" name="b" id="" required> <br></td>
            </tr>
            <tr>
                <td>Masukkan c</td>
                <td>:</td>
                <td><input type="number" name="c" id="" required> <br></td>
            </tr>
            <tr>
                <td>Masukkan d</td>
                <td>:</td>
                <td><input type="number" name="d" id="" required> <br></td>
            </tr>
            <tr>
                <td>Masukkan t</td>
                <td>:</td>
                <td><input type="number" name="t" id="" required></td>
            </tr>
            <tr>
                <td>Pilih</td>
                <td>:</td>
